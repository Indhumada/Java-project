                ...
                <div id="content">
                    ...
                    <center>
                        <table style="border-style: solid">
                            <caption> <h2 style="color: darkslateblue;font-family: monospace;font-weight: bold;font-size: 30px">CLOUD UPLOADS VIEW</h2></caption>
                            <tr style="background-color: #999999;font-size: 18px;font-family: monospace;font-weight: bold;text-align: center">                                
                                <td style="text-align: center">FILE NAME</td> <td style="text-align: center">OWNER NAME</td><td style="text-align: center">UPLOAD TIME</td><td style="text-align: center">SIZE</td>
                            </tr>
                            <%
                                while (rt.next()) {
