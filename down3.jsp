                    ...
                    <%
                        ...
                        if (rt.next()) {
                            ...
                            try {
                                ...
                                int i = smt.executeUpdate("insert into downloads (filename,username,time)values('" + fname + "','" + user + "','" + time + "')");
//                                if (i != 0) {
//                                    response.sendRedirect("user_page.jsp?completed");
//                                } else {
//                                    response.sendRedirect("user_page.jsp?updationFailed");
//                                }
                            } catch (Exception ex) {
                                ex.printStackTrace();
                            }
