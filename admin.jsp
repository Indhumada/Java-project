        ...
        <div id="main">
            ...
            <div id="site_content">
                <div id="sidebar_container">
                    <div class="gallery">
                        <ul class="images">
                            <li class="show"><img width="450" height="450" src="images/model.png" alt="photo_one" /></li>
                ...
                <div id="content">
                    <fieldset style="background-color: lightblue;border-radius: 9px;height: 350px;margin-top: 40px;background-image: url('images/audit.jpg')">
                        <center>
                            <h1 style="font: monospace;font-size: 35px;font-weight: bold;color: darkslateblue">Auditor Login</h1><br>
