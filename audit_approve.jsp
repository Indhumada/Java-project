            ...
            <div id="site_content">
                <div id="content">
                    <%  Connection con = Dbconnection.getConn();
                        ...
                        ResultSet rt = st.executeQuery("select * from files where status='No'");
                    %>
                    <center>
                        <table style="border-style: solid;">
                            <caption> <h2 style="color: darkslateblue;font-family: monospace;font-weight: bold;font-size: 30px"> FILES REQUESTS TO CLOUD UPLOAD</h2></caption>
                            <tr style="background-color: #999999;font-size: 18px;font-family: monospace;font-weight: bold;">                                
                                <td style="text-align: center">FILE NAME</td> <td style="text-align: center">OWNER NAME</td><td style="text-align: center">UPLOAD TIME</td><td style="text-align: center">SIZE</td><td style="text-align: center">APPROVE</td>
                            </tr>
                            <%
                                while (rt.next()) {
                            ...
                            <TR>
                                ...
                                <td style="text-align: center"><a href="audit_upl.jsp?<%=rt.getString("filename")%>">Upload to Cloud</a></td>
                            </TR>
                            <%}%>
                        </table>
                    </center>
